...
<link rel="stylesheet" type="text/css" href="<%=basePath%>css/p_DataBrowsing.css">
<link rel="stylesheet" type="text/css" href="<%=basePath%>css/page.css">
<link rel="stylesheet" type="text/css" href="<%=basePath%>css/p_header.css" />
<link rel="stylesheet" type="text/css" href="<%=basePath%>css/examine.css" />
<link rel="stylesheet" type="text/css" href="<%=basePath%>css/style.css">
<link type="text/css" rel="stylesheet" href="<%=basePath%>css/paging.css">
...
<script type="text/javascript" src="<%=basePath%>js/linkage4.js"></script>
...
<body>
	<header style="height: 50px; background-color: #c0dafb;">
		<div class="logo_right_box">
			<ul class="logo_right_left">
				<li><a class="datebrowsing"
					href="<%=basePath%>jsp/person_first1.jsp"><span
						style="padding: 12px; color: #58a0fd">数据浏览</span></a></li>
				<li><a class="chartview"
					href="<%=basePath%>jsp/customer - chartview.html"><span
						style="padding: 12px;">图表查看</span></a></li>
				<li><a class="regional"
					href="<%=basePath%>jsp/customer - reqion.html"><span>地域分布图</span></a></li>
			</ul>
					...
					<div id="dropdown_box"
						...
						<ul class="dropdown_ul">
							<li class="dropdown_li"><a class="llhistry"
								href="<%=basePath%>jsp/person_DataBrowsing.html"><span>浏览记录</span></a></li>
							<li class="dropdown_li"><a class="updatebro"
								href="<%=basePath%>jsp/person_DataBrowsin.html"><span>下载记录</span></a></li>
							<li class="dropdown_li"><a class="pwdup"
								href="<%=basePath%>jsp/person_updatePassword.html"><span>密码修改</span></a></li>
						</ul>
					</div></li>
			</ul>
		</div>
	...
	<article class="arcbox box">
		<span>污染率 </span> <select id="pollution_rate" name="pollution_rate"
			class="mainSpecies">
	...
	<article class="">
		<div class="screens">
			...
			<div class="screen_right">
				<span><em>苹果</em><i class="delCate">×</i></span> <span><em>猕猴桃</em><i
					class="delCate">×</i></span> <span><em>梨</em><i class="delCate">×</i></span>
			</div>
		</div>
		<div class="screens">
		...
		<div class="screens">
			...
			<div class="screen_right">
				<span><em>湖南</em><i class="delCate">×</i></span> <span><em>北京</em><i
					class="delCate">×</i></span> <span><em>山东</em><i class="delCate">×</i></span>
			</div>
		</div>
		<div class="screens">
			<div class="screen_left">毒素&gt;</div>
			<div class="screen_right">
				<span><em>黄曲霉毒素M1</em><i class="delCate">×</i></span> <span><em>DON</em><i
					class="delCate">×</i></span> <span><em>黄曲霉毒素总量</em><i
					class="delCate">×</i></span> <span><em>伏马菌素</em><i class="delCate">×</i></span>
			</div>
		</div>
	</article>
	<article class="arc0">
		<div class="arc1">
			<span class="yanpbh">样品编号</span> <span class="addrr">取样信息</span> <span
				class="nzwclass">农作物种类</span> <span class="wrl">污染率</span> <span
				class="qydate">取样时间</span> <span class="zyds">主要毒素种类</span> <span
				class="cpjz">产毒菌株信息</span> <span class="caozuo">操作</span>
		</div>
	</article>
	<article class="article_box box">
		...
		<div class="articles_box">
			...
			<div class="seria_right">
				...
				<div class="articles_box_nr sample_info2">
					<ul>
						<li><span class="sam_info_value">黄曲霉毒素M1:</span><span
							class="sam_info_value">12.0</span></li>
					</ul>
				</div>
				<div class="articles_box_nr cpjz sample_info3">
					<ul>
						<li><span>原始编号：</span> <span class="sam_info_value">asd123123-1</span>
						</li>

						<li><span>图片文件：</span><span class="sam_info_value"> <a
								href="/upload/img/asdadasd.png" target="_blank">asdadasd.png</a>
						</span></li>
						<li><span>文档信息：</span> <span class="sam_info_value"> <a
								href="/glory/rest/lookword?url=123123123.docx" target="_blank">123123123.docx</a>
						</span></li>
						<li><span>TXT文本信息：</span> <span class="sam_info_value">
				...
				<div class="articles_box_nr caozuo sample_info4">
					<ul>
						<li class="downline"><a href="/glory/rest/downlineZIP?id=">下载</a>
						</li>
						<li class="showbox">展开
							<div style="display: none">1</div> <span id="showa"></span>
						</li>
		...
		<div class="articles_box">
			...
			<div class="seria_right">
				...
				<div class="articles_box_nr sample_info2">
					<ul>
						<li><span class="sam_info_value">DON:</span><span
							class="sam_info_value">15.0</span></li>

						<li><span class="sam_info_value">黄曲霉毒素总量:</span><span
							class="sam_info_value">30.0</span></li>

						<li><span class="sam_info_value">DON:</span><span
							class="sam_info_value">33.5</span></li>

						<li><span class="sam_info_value">DON:</span><span
							class="sam_info_value"></span></li>
					</ul>
				</div>
				<div class="articles_box_nr cpjz sample_info3">
					<ul>
						<li><span>原始编号：</span> <span class="sam_info_value">asd123123-01</span>
						</li>
						...
						<li><span>文档信息：</span> <span class="sam_info_value"> <a
								href="/glory/rest/lookword?url=" target="_blank"></a>
						</span></li>
						<li><span>TXT文本信息：</span> <span class="sam_info_value">
				...
				<div class="articles_box_nr caozuo sample_info4">
					<ul>
						<li class="downline"><a href="/glory/rest/downlineZIP?id=2=">下载</a>
						</li>
						<li class="showbox">展开
							<div style="display: none">2</div> <span id="showa"></span>
						</li>
						<li class="hidebox">收起 <span id="hidea"></span></li>
					</ul>
				</div>
		...
		<div class="articles_box">
			...
			<div class="seria_right">
				...
				<div class="articles_box_nr sample_info2">
					<ul>
						<li><span class="sam_info_value">DON:</span><span
							class="sam_info_value">20.0</span></li>
				...
				<div class="articles_box_nr caozuo sample_info4">
					<ul>
						<li class="downline"><a href="/glory/rest/downlineZIP?id=+3=">下载</a>
						</li>
						<li class="showbox">展开
							<div style="display: none">3</div> <span id="showa"></span>
						</li>
						<li class="hidebox">收起 <span id="hidea"></span></li>
					</ul>
				</div>
			...
			<div class="seria_right">
				...
				<div class="articles_box_nr sample_info2">
					<ul>
						...
						<li><span class="sam_info_value">伏马菌素:</span><span
							class="sam_info_value">23.0</span></li>

						<li><span class="sam_info_value">DON:</span><span
							class="sam_info_value">2.0</span></li>
					</ul>
				</div>
				<div class="articles_box_nr cpjz sample_info3">
					<ul>
						<li><span>原始编号：</span> <span class="sam_info_value">A-123456-001</span>
						</li>

						<li><span>图片文件：</span><span class="sam_info_value"> <a
								href="/upload/txt/20180307172217349.txt" target="_blank">20180307172217349.txt</a>
						</span></li>
						<li><span>文档信息：</span> <span class="sam_info_value"> <a
								href="/glory/rest/lookword?url=" target="_blank"></a>
						</span></li>
				...
				<div class="articles_box_nr caozuo sample_info4">
					<ul>
						<li class="downline"><a href="/glory/rest/downlineZIP?id=+5=">下载</a>
						</li>
						<li class="showbox">展开
							<div style="display: none">5</div> <span id="showa"></span>
						</li>
						<li class="hidebox">收起 <span id="hidea"></span></li>
					</ul>
				</div>
		...
		<div class="articles_box">
			...
			<div class="seria_right">
				...
				<div class="articles_box_nr sample_info2">
					<ul>
						<li><span class="sam_info_value">黄曲霉毒素总量:</span><span
							class="sam_info_value">11.0</span></li>
					</ul>
				</div>
				<div class="articles_box_nr cpjz sample_info3">
					<span class="sam_info_value"></span>
				...
				<div class="articles_box_nr caozuo sample_info4">
					<ul>
						<li class="downline"><a href="/glory/rest/downlineZIP?id=+7=">下载</a>
						</li>
						<li class="showbox">展开
							<div style="display: none">7</div> <span id="showa"></span>
						</li>
						<li class="hidebox">收起 <span id="hidea"></span></li>
					</ul>
				</div>
