...
<html>
		...
		<meta charset="UTF-8">
		<title>系统管理</title>
<link rel="stylesheet" type="text/css" href="<%=basePath%>css/conmen-header.css"/>
<link rel="stylesheet" href="<%=basePath%>css/reset.css" />
<link rel="stylesheet" href="<%=basePath%>css/user-management-index.css" />
...
<body>
<div class="xtgl"> 
<a class="dall dactive public" href="<%=basePath%>jsp/superadmin.jsp">用户管理</a>
<a class="chart public" href="<%=basePath%>jsp/categorylist.jsp">类别管理</a>
<a class="mps public" href="<%=basePath%>jsp/categorylist - dusu.jsp">毒素管理</a>
</div>
<div class="user-content">
 <p class="user-admin"><span>当前页面 : </span><a>用户管理</a></p>
  <div class="user-search">
    ...
    <a onclick="" class="search-btn">搜索</a> <a class="user-add" href="<%=basePath%>jsp/user-management-add.jsp">新增用户</a> </div>
  <table class = "user-info">
    ...
    <tr class="info-item">
      ...
      <td>超级管理员</td>
      <td>停用</td>
      <td><a href="<%=basePath%>jsp/user-management-modify.jsp" class="edit">编辑</a><a href="javascript:if(confirm('确实要删除吗?'))location='<%=path%>/rest/deleteUserById?id=${li.id}'" class="delete">删除</a></td>
    </tr>
    <tr class="info-item">
      <td>2</td>
      <td>user-name</td>
    ...
    <tr class="info-item">
      ...
      <td>超级管理员</td>
      <td>启用</td>
      <td><a href="<%=basePath%>jsp/editIM.jsp" class="edit">编辑</a><a href="javascript:if(confirm('确实要删除吗?'))location='<%=path%>/rest/deleteUserById?id=${li.id}'" class="delete">删除</a></td>
    </tr>
    <tr class="info-item">
      <td>9</td>
      <td>user-name</td>
