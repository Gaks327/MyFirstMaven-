  ...
  <form  method="post" id="formUpdate">
    <div class="cus-modify-infolist">
      ...
      <ul class="modify-list">
        ...
        <li>
          <lable>开始时间</lable>
          <input onblur="checkharvest_time()" type="text" name="starttime" value="${user.starttime }" id="dt" placeholder="选择日期" readonly>
        ...
        <li>
          <lable>结束时间</lable>
          <input onblur="checksampling_time()" type="text" name="endtime" value="${user.endtime }" id="dt-b" placeholder="选择日期" readonly>
      ...
      <div class="modify-option"> <a class="cus-modify" href="<%=basePath%>updateById" onclick="sub()">修改</a><a class="modify-back" href="<%=basePath%>jsp/customerList.jsp">返回</a> </div>
    </div>
  </form>
</div>
