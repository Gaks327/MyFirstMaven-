...
<link rel="stylesheet" href="<%=basePath%>css/china.css" />
</head>
...
<body>
	...
	<article class="echartmap">
		<div id="main" class="echart_map">
			<iframe src="<%=basePath%>jsp/ee.jsp" id="mainiframe" width="100%" height="100%"  frameborder="no" border="0" iframe  name="if" scrolling="no"></iframe>
