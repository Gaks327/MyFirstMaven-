...
<head>
    ...
    <script type="text/javascript" src="<%=basePath%>js/chinaMapConfig.js"></script>
    <script type="text/javascript" src="<%=basePath%>js/worldMapConfig.js"></script>
    ...
    <style type="text/css">
        ...
        .wrap{ width:100%; margin:0 auto; background:url(./images/bg.png); border-left:1px solid #DDD; border-right:1px solid #DDD;}
...
<div class="wrap">
    <div class="items" id="Item9">
        ...
        <div class="itemCon">
            ...
            <div id="Region" style="position:relative; height:700px;">
                ...
                <div id="MapColor" style=" float:left; width: 75px; height: 180px; background:url(<%=basePath%>img/map_color.png) center 0; background-size: 100%"></div>
                <span style="display: inline-block;width: 77px;height: 105px;background-image: url(<%=basePath%>img/nanhainew.png);background-size: 100%;margin-top: 360px;margin-left: -70px;"></span>
            </div>
...
<script type="text/javascript" src="<%=basePath%>js/SyntaxHighlighter.js"></script>
</body>
</html>